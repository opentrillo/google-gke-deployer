...
[on-screen instructions](https://console.cloud.google.com/marketplace/details/google/trillo-rt).
...
[![Open in Cloud Shell](http://gstatic.com/cloudssh/images/open-btn.svg)](https://console.cloud.google.com/cloudshell/editor?cloudshell_git_repo=https://github.com/GoogleCloudPlatform/click-to-deploy&cloudshell_open_in_editor=README.md&cloudshell_working_dir=k8s/trillo-rt)
...
```shell
export CLUSTER=trillo-rt-cluster
...
Navigate to the `trillo-rt` directory:

```shell
cd click-to-deploy/k8s/trillo-rt
```
...
```shell
export APP_INSTANCE_NAME=trillo-rt-1
